...
// Calculate helper variables for generating 'a' and 'b' coefficients
	...
	float alpha = sn / (2*Q);
	float beta = sqrt(A + A);
// Load 'a' and 'b' coefficients into tmp biquad
/////////////////////////////////
...
// Load 'a' and 'b' coefficients into tmp biquad
/////////////////////////////////
	bq_load_coefficients(bq, filter_type, A, omega, sn, cs, alpha, beta);
